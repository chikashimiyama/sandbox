...
// instantiation of these classes are only possible via Dataset class.
//  
//
...
// Dataset maintains many Event, knows its time format, and create event
class Dataset{
public:
	enum TimeFormat{
		MGM_MODE_DELTA_TIME,
...
inline void Dataset::addEvent(double deltaTime, Data dt){
